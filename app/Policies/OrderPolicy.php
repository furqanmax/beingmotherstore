...
class OrderPolicy
{
    ...
    {
        return $user->hasPermissionTo('delete-any Order');
    }
    ...
    {
        return $user->hasPermissionTo('restore-any Order');
    }
    ...
    {
        return $user->hasPermissionTo('replicate Order');
    }
    ...
    {
        return $user->hasPermissionTo('reorder Order');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete-any Order');
    }
