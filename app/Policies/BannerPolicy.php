...
class BannerPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-any Banner');
    }
    ...
    {
        return $user->hasPermissionTo('delete-any Banner');
    }
    ...
    {
        return $user->hasPermissionTo('restore-any Banner');
    }
    ...
    {
        return $user->hasPermissionTo('replicate Banner');
    }
    ...
    {
        return $user->hasPermissionTo('reorder Banner');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete Banner');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete-any Banner');
    }
